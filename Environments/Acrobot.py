...
class AcrobotEnv(core.Env):
    ...
    **REFERENCE:**
    ...
    def reset(self):
        ...
        return self._get_ob(), {'env_state': self.state}
    ...
    def step(self, a):
        ...
        return (self._get_ob(), reward, terminal, {'env_state': self.state})
