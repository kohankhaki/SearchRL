...
if __name__ == '__main__':
    ...
    # x = time.time()
    detail = "Env = 4room - 4x4; with pre-trained DQN (64x64): dqn_vf_42.p"
    experiment.run_experiment(experiment_object_list, result_file_name="DQNMCTS_InitialValue_PretrainedDQN64x64_dqn_vf_42.p", detail=detail)
    # print(time.time() - x)
